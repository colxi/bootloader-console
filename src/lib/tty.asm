use16
TTY_BUFFER_SIZE     EQU 255                     ; Max sie of the tty input
...
initTTY:
    ...
    .addChar:
        ...
        inc     cl                      ; increase string lenght counter
        call    printChar               ; print the prssed character
        jmp     .getKey                 ; listen to next keystoke
    ;***************************************************************************
    .printBackspace:
        cmp     cl,     0               ; if in beggining of buffer
        ...
        dec     cl                      ; decrement by 1 the sting length
        jmp     .getKey                 ; listen to next keystoke
    ;***************************************************************************
    .printEnter:
